...
describe("Info Flow", () => {
  describe("flow definition", () => {
    it("should have correct name", () => {
      expect(infoFlow.name).toBe("info");
    });

    it("should have a description", () => {
      expect(infoFlow.description).toBeDefined();
      expect(infoFlow.description.length).toBeGreaterThan(0);
    });

    it("should have timeout configured", () => {
      expect(infoFlow.timeoutMinutes).toBeGreaterThan(0);
    });

    it("should have steps defined", () => {
      expect(infoFlow.steps).toBeDefined();
      expect(infoFlow.steps.size).toBeGreaterThan(0);
    });

    it("should have initial step defined", () => {
      expect(infoFlow.initialStep).toBeDefined();
      expect(infoFlow.hasStep(infoFlow.initialStep)).toBe(true);
    });
  });

  describe("steps", () => {
    it("should start with select_topic step", () => {
      expect(infoFlow.initialStep).toBe("select_topic");
    });

    it("should have all required steps", () => {
      expect(infoFlow.hasStep("select_topic")).toBe(true);
      expect(infoFlow.hasStep("show_horarios")).toBe(true);
      expect(infoFlow.hasStep("show_ubicacion")).toBe(true);
      expect(infoFlow.hasStep("show_contacto")).toBe(true);
      expect(infoFlow.hasStep("show_envios")).toBe(true);
      expect(infoFlow.hasStep("show_pagos")).toBe(true);
      expect(infoFlow.hasStep("show_garantia")).toBe(true);
      expect(infoFlow.hasStep("ask_more")).toBe(true);
    });
    ...
    describe("select_topic step", () => {
      ...
      beforeAll(() => {
        step = infoFlow.getStep("select_topic")!;
      });
    ...
    describe("show_horarios step", () => {
      ...
      beforeAll(() => {
        step = infoFlow.getStep("show_horarios")!;
      });
    ...
    describe("show_ubicacion step", () => {
      ...
      beforeAll(() => {
        step = infoFlow.getStep("show_ubicacion")!;
      });
    ...
    describe("show_envios step", () => {
      ...
      beforeAll(() => {
        step = infoFlow.getStep("show_envios")!;
      });
    ...
    describe("show_pagos step", () => {
      ...
      beforeAll(() => {
        step = infoFlow.getStep("show_pagos")!;
      });
    ...
    describe("ask_more step", () => {
      ...
      beforeAll(() => {
        step = infoFlow.getStep("ask_more")!;
      });
      ...
      it("should loop back to select_topic when user wants more", () => {
        const nextStepFn = step.nextStep as (input: string) => string | null;
  ...
  describe("getInitialStep", () => {
    it("should return the initial step", () => {
      const initialStep = infoFlow.getInitialStep();
