...
describe("GeolocationService", () => {
  ...
  describe("calculateDistance", () => {
    it("should calculate distance between two points", () => {
      const point1: Coordinates = { latitude: -34.5614, longitude: -58.4537 };
      const point2: Coordinates = { latitude: -34.5789, longitude: -58.4321 };
    ...
    it("should return 0 for same coordinates", () => {
      const point: Coordinates = { latitude: -34.5614, longitude: -58.4537 };
    ...
    it("should calculate larger distances correctly", () => {
      ...
      const belgrano: Coordinates = { latitude: -34.5614, longitude: -58.4537 };
      const quilmes: Coordinates = { latitude: -34.7234, longitude: -58.2567 };
  ...
  describe("isWithinCoverageArea", () => {
    ...
    it("should handle edge cases at boundaries", () => {
      // Límite norte
      const north: Coordinates = { latitude: -34.2, longitude: -58.4 };
      expect(service.isWithinCoverageArea(north)).toBe(true);

      // Límite sur
      const south: Coordinates = { latitude: -35.2, longitude: -58.4 };
      expect(service.isWithinCoverageArea(south)).toBe(true);

      // Fuera del límite
      const outside: Coordinates = { latitude: -35.3, longitude: -58.4 };
