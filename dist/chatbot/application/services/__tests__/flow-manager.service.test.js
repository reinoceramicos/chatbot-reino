...
const createTestFlow = () => {
    ...
    steps.set("step1", {
        ...
        saveAs: "choice",
        nextStep: (input) => (input === "opt1" ? "step2" : "step3"),
    });
    steps.set("step2", {
        id: "step2",
        prompt: {
...
describe("FlowManagerService", () => {
    ...
    const testFlowType = "quotation"; // Use a valid FlowType
    beforeEach(() => {
        flowManager = new flow_manager_service_1.FlowManagerService();
    ...
    describe("registerFlow", () => {
        it("should register a flow", () => {
            ...
            const newFlow = new flow_entity_1.Flow({
                name: "info",
    ...
    describe("processFlowInput", () => {
        it("should process button reply and advance to next step", () => {
            ...
            const result = flowManager.processFlowInput(conversation, "opt1", "button_reply", testWaId);
            expect(result).toBeDefined();
        ...
        it("should process text input and advance to next step", () => {
            ...
            const result = flowManager.processFlowInput(conversation, "valid text", "text", testWaId);
            expect(result).toBeDefined();
        ...
        it("should return validation error for invalid input", () => {
            ...
            const result = flowManager.processFlowInput(conversation, "ab", // Too short, validation requires >= 3
            "text", testWaId);
            expect(result).toBeDefined();
        ...
        it("should mark flow as completed when reaching final step", () => {
            ...
            const result = flowManager.processFlowInput(conversation, "anything", "text", testWaId);
            expect(result).toBeDefined();
        ...
        it("should return null for unregistered flow type", () => {
            ...
            const result = flowManager.processFlowInput(conversation, "test", "text", testWaId);
            expect(result).toBeNull();
        });
