...
describe("Message Entity", () => {
    describe("constructor validation", () => {
        it("should throw error when 'to' is missing", () => {
            expect(() => {
                new message_entity_1.Message("", "text", { text: { body: "test" } });
            }).toThrow("Recipient 'to' is required");
        });
        it("should throw error when type is missing", () => {
            expect(() => {
                new message_entity_1.Message("5491155556666", "", { text: { body: "test" } });
            }).toThrow("Message type is required");
        });
        it("should create message with valid parameters", () => {
            const message = new message_entity_1.Message("5491155556666", "text", { text: { body: "Hello" } });
    ...
    describe("createText", () => {
        it("should create text message with body only", () => {
            const message = message_entity_1.Message.createText("5491155556666", "Hello World");
            expect(message.to).toBe("5491155556666");
            expect(message.type).toBe("text");
        ...
        it("should create text message with preview URL enabled", () => {
            const message = message_entity_1.Message.createText("5491155556666", "Check this: https://example.com", true);
            expect(message.content.text?.previewUrl).toBe(true);
        });
        it("should create text message with phoneNumberId", () => {
            const message = message_entity_1.Message.createText("5491155556666", "Hello", false, "123456789");
            expect(message.phoneNumberId).toBe("123456789");
        });
    });
    describe("createImage", () => {
        it("should create image message with URL", () => {
            const message = message_entity_1.Message.createImage("5491155556666", "https://example.com/image.jpg");
        ...
        it("should create image message with ID", () => {
            const message = message_entity_1.Message.createImage("5491155556666", "media-id-123", true);
        ...
        it("should create image message with caption", () => {
            const message = message_entity_1.Message.createImage("5491155556666", "https://example.com/image.jpg", false, "My photo");
            expect(message.content.media?.caption).toBe("My photo");
        });
    });
    describe("createVideo", () => {
        it("should create video message with URL", () => {
            const message = message_entity_1.Message.createVideo("5491155556666", "https://example.com/video.mp4");
        ...
        it("should create video message with ID and caption", () => {
            const message = message_entity_1.Message.createVideo("5491155556666", "video-id", true, "Check this video");
    ...
    describe("createAudio", () => {
        it("should create audio message with URL", () => {
            const message = message_entity_1.Message.createAudio("5491155556666", "https://example.com/audio.ogg");
        ...
        it("should create audio message with ID", () => {
            const message = message_entity_1.Message.createAudio("5491155556666", "audio-id", true);
            expect(message.content.media?.id).toBe("audio-id");
        });
    });
    describe("createDocument", () => {
        it("should create document message with URL", () => {
            const message = message_entity_1.Message.createDocument("5491155556666", "https://example.com/doc.pdf");
        ...
        it("should create document message with caption and filename", () => {
            const message = message_entity_1.Message.createDocument("5491155556666", "https://example.com/doc.pdf", false, "Price list", "precios.pdf");
    ...
    describe("createSticker", () => {
        it("should create sticker message with URL", () => {
            const message = message_entity_1.Message.createSticker("5491155556666", "https://example.com/sticker.webp");
        ...
        it("should create sticker message with ID", () => {
            const message = message_entity_1.Message.createSticker("5491155556666", "sticker-id", true);
            expect(message.content.media?.id).toBe("sticker-id");
        });
    });
    describe("createLocation", () => {
        it("should create location message with coordinates only", () => {
            const message = message_entity_1.Message.createLocation("5491155556666", -34.6037, -58.3816);
        ...
        it("should create location message with name and address", () => {
            const message = message_entity_1.Message.createLocation("5491155556666", -34.6037, -58.3816, "Reino Ceramicos", "Av. Principal 1234");
    ...
    describe("createContacts", () => {
        it("should create contacts message", () => {
            ...
            const message = message_entity_1.Message.createContacts("5491155556666", contacts);
    ...
    describe("createReaction", () => {
        it("should create reaction message", () => {
            const message = message_entity_1.Message.createReaction("5491155556666", "wamid.original123", "👍");
