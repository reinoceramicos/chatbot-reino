import { SendButtonMessageUseCase, SendListMessageUseCase } from "../send-interactive.use-case";
...
describe("SendButtonMessageUseCase", () => {
  let useCase: SendButtonMessageUseCase;
  let mockAdapter: jest.Mocked<MessagingPort>;

  beforeEach(() => {
    mockAdapter = createMockMessagingAdapter();
    useCase = new SendButtonMessageUseCase(mockAdapter);
  });
...
describe("SendListMessageUseCase", () => {
  let useCase: SendListMessageUseCase;
  let mockAdapter: jest.Mocked<MessagingPort>;

  beforeEach(() => {
    mockAdapter = createMockMessagingAdapter();
    useCase = new SendListMessageUseCase(mockAdapter);
  });
