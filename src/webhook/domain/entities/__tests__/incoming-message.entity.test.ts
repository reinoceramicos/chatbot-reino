...
describe("IncomingMessage Entity", () => {
  ...
  describe("isText", () => {
    ...
    it("should return false for non-text messages", () => {
      const types: IncomingMessageType[] = [
        "image",
        "audio",
        "video",
        "location",
  ...
  describe("isMedia", () => {
    it("should return true for media message types", () => {
      const mediaTypes: IncomingMessageType[] = [
        "image",
        "audio",
        "voice",
        "video",
      ...
      mediaTypes.forEach((type) => {
        const message = new IncomingMessage(
          ...
          defaultSender,
          defaultPhoneNumberId,
          { media: { id: "123", mimeType: "image/jpeg" } }
        );
    ...
    it("should return false for non-media types", () => {
      const nonMediaTypes: IncomingMessageType[] = [
        "text",
        "location",
        "contacts",
        "interactive",
