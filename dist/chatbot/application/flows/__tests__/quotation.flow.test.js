...
const quotation_flow_1 = require("../quotation.flow");
describe("Quotation Flow", () => {
    describe("flow definition", () => {
        it("should have correct name", () => {
            expect(quotation_flow_1.quotationFlow.name).toBe("quotation");
        });
        it("should have a description", () => {
            expect(quotation_flow_1.quotationFlow.description).toBeDefined();
            expect(quotation_flow_1.quotationFlow.description.length).toBeGreaterThan(0);
        });
        it("should have timeout configured", () => {
            expect(quotation_flow_1.quotationFlow.timeoutMinutes).toBeGreaterThan(0);
        });
        it("should have steps defined", () => {
            expect(quotation_flow_1.quotationFlow.steps).toBeDefined();
            expect(quotation_flow_1.quotationFlow.steps.size).toBeGreaterThan(0);
        });
        it("should have initial step defined", () => {
            expect(quotation_flow_1.quotationFlow.initialStep).toBeDefined();
            expect(quotation_flow_1.quotationFlow.hasStep(quotation_flow_1.quotationFlow.initialStep)).toBe(true);
        });
    });
    describe("steps", () => {
        it("should start with select_category step", () => {
            expect(quotation_flow_1.quotationFlow.initialStep).toBe("select_category");
        });
        it("should have all required steps", () => {
            expect(quotation_flow_1.quotationFlow.hasStep("select_category")).toBe(true);
            expect(quotation_flow_1.quotationFlow.hasStep("ask_details")).toBe(true);
            expect(quotation_flow_1.quotationFlow.hasStep("ask_quantity")).toBe(true);
            expect(quotation_flow_1.quotationFlow.hasStep("ask_location_method")).toBe(true);
            expect(quotation_flow_1.quotationFlow.hasStep("waiting_location")).toBe(true);
            expect(quotation_flow_1.quotationFlow.hasStep("select_zone")).toBe(true);
            expect(quotation_flow_1.quotationFlow.hasStep("select_store")).toBe(true);
            expect(quotation_flow_1.quotationFlow.hasStep("ask_contact")).toBe(true);
            expect(quotation_flow_1.quotationFlow.hasStep("confirm")).toBe(true);
        });
        describe("select_category step", () => {
            let step;
            beforeAll(() => {
                step = quotation_flow_1.quotationFlow.getStep("select_category");
            });
        ...
        describe("ask_details step", () => {
            let step;
            beforeAll(() => {
                step = quotation_flow_1.quotationFlow.getStep("ask_details");
            });
        ...
        describe("ask_quantity step", () => {
            let step;
            beforeAll(() => {
                step = quotation_flow_1.quotationFlow.getStep("ask_quantity");
            });
            it("should be a text type", () => {
                expect(step.prompt.type).toBe("text");
            });
        ...
        describe("ask_location_method step", () => {
            let step;
            beforeAll(() => {
                step = quotation_flow_1.quotationFlow.getStep("ask_location_method");
            });
        ...
        describe("waiting_location step", () => {
            let step;
            beforeAll(() => {
                step = quotation_flow_1.quotationFlow.getStep("waiting_location");
            });
            it("should be a text type", () => {
                expect(step.prompt.type).toBe("text");
            });
        ...
        describe("select_zone step", () => {
            let step;
            beforeAll(() => {
                step = quotation_flow_1.quotationFlow.getStep("select_zone");
            });
            it("should be a list type", () => {
                expect(step.prompt.type).toBe("list");
            });
        ...
        describe("select_store step", () => {
            let step;
            beforeAll(() => {
                step = quotation_flow_1.quotationFlow.getStep("select_store");
            });
            it("should be a list type", () => {
                expect(step.prompt.type).toBe("list");
            });
        ...
        describe("ask_contact step", () => {
            let step;
            beforeAll(() => {
                step = quotation_flow_1.quotationFlow.getStep("ask_contact");
            });
            it("should be a button type", () => {
                expect(step.prompt.type).toBe("button");
            });
            ...
            it("should have WhatsApp option", () => {
                const hasWhatsApp = step.prompt.buttons.some((b) => b.id.includes("whatsapp") || b.title.toLowerCase().includes("whatsapp"));
                expect(hasWhatsApp).toBe(true);
            });
            it("should have email option", () => {
                const hasEmail = step.prompt.buttons.some((b) => b.id.includes("email") || b.title.toLowerCase().includes("email"));
        ...
        describe("ask_email step", () => {
            let step;
            beforeAll(() => {
                step = quotation_flow_1.quotationFlow.getStep("ask_email");
            });
            it("should be a text type", () => {
                expect(step.prompt.type).toBe("text");
            });
        ...
        describe("confirm step", () => {
            let step;
            beforeAll(() => {
                step = quotation_flow_1.quotationFlow.getStep("confirm");
            });
            it("should be a button type", () => {
                expect(step.prompt.type).toBe("button");
            });
    ...
    describe("getInitialStep", () => {
        it("should return the initial step", () => {
            const initialStep = quotation_flow_1.quotationFlow.getInitialStep();
    ...
    describe("createMessageForStep", () => {
        ...
        it("should create list message for select_category", () => {
            const step = quotation_flow_1.quotationFlow.getStep("select_category");
            const message = quotation_flow_1.quotationFlow.createMessageForStep(step, testWaId);
        ...
        it("should create text message for ask_details", () => {
            const step = quotation_flow_1.quotationFlow.getStep("ask_details");
            const message = quotation_flow_1.quotationFlow.createMessageForStep(step, testWaId);
            expect(message.type).toBe("text");
            expect(message.to).toBe(testWaId);
        });
        it("should create button message for ask_contact", () => {
            const step = quotation_flow_1.quotationFlow.getStep("ask_contact");
            const message = quotation_flow_1.quotationFlow.createMessageForStep(step, testWaId);
            expect(message.type).toBe("interactive");
