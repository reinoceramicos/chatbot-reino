import { InteractiveMessage } from "../interactive-message.entity";

describe("InteractiveMessage", () => {
  describe("Button Message", () => {
    it("should create a button message with factory method", () => {
      const msg = InteractiveMessage.createButtonMessage(
        "5491155556666",
        "Choose an option:",
        [
    ...
    it("should include header and footer when provided", () => {
      const msg = InteractiveMessage.createButtonMessage(
        ...
        "Choose:",
        [{ id: "btn_1", title: "Option 1" }],
        { header: "Welcome!", footer: "Select one" }
      );
    ...
    it("should throw error for empty buttons", () => {
      expect(() =>
        InteractiveMessage.createButtonMessage("5491155556666", "Choose:", [])
      ).toThrow("Button message must have at least one button");
    });
    ...
    it("should throw error for body text exceeding 1024 chars", () => {
      ...
      expect(() =>
        InteractiveMessage.createButtonMessage("5491155556666", longBody, [
          { id: "btn_1", title: "Option 1" },
        ])
    ...
    it("should throw error for missing recipient", () => {
      expect(() =>
        InteractiveMessage.createButtonMessage("", "Choose:", [
          { id: "btn_1", title: "Option 1" },
        ])
  ...
  describe("List Message", () => {
    it("should create a list message with factory method", () => {
      const msg = InteractiveMessage.createListMessage(
        "5491155556666",
        "Select a product:",
        "Ver productos",
        [
    ...
    it("should include header and footer when provided", () => {
      const msg = InteractiveMessage.createListMessage(
        ...
        { header: "Catálogo", footer: "Precios sin IVA" }
      );
    ...
    it("should throw error for empty sections", () => {
      expect(() =>
        InteractiveMessage.createListMessage("5491155556666", "Select:", "Ver", [])
      ).toThrow("List message must have at least one section");
    });
    ...
    it("should throw error for more than 10 sections", () => {
      ...
      expect(() =>
        InteractiveMessage.createListMessage("5491155556666", "Select:", "Ver", sections)
      ).toThrow("List message cannot have more than 10 sections");
    });
    ...
    it("should throw error for more than 10 total rows across sections", () => {
      ...
      expect(() =>
        InteractiveMessage.createListMessage("5491155556666", "Select:", "Ver", sections)
      ).toThrow("List message cannot have more than 10 total rows");
    });
    ...
    it("should throw error for button text exceeding 20 chars", () => {
      expect(() =>
        InteractiveMessage.createListMessage(
          "5491155556666",
          "Select:",
          "This button text is too long",
          [{ rows: [{ id: "item_1", title: "Item 1" }] }]
        )
      ).toThrow("List button text must not exceed 20 characters");
    });
  });
