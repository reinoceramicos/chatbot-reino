...
describe("SendVideoUseCase", () => {
  let useCase: SendVideoUseCase;
  let mockAdapter: jest.Mocked<MessagingPort>;

  beforeEach(() => {
    mockAdapter = createMockMessagingAdapter();
    useCase = new SendVideoUseCase(mockAdapter);
  });
...
describe("SendAudioUseCase", () => {
  let useCase: SendAudioUseCase;
  let mockAdapter: jest.Mocked<MessagingPort>;

  beforeEach(() => {
    mockAdapter = createMockMessagingAdapter();
    useCase = new SendAudioUseCase(mockAdapter);
  });
...
describe("SendDocumentUseCase", () => {
  ...
  beforeEach(() => {
    mockAdapter = createMockMessagingAdapter();
    useCase = new SendDocumentUseCase(mockAdapter);
  });
...
describe("SendStickerUseCase", () => {
  let useCase: SendStickerUseCase;
  let mockAdapter: jest.Mocked<MessagingPort>;

  beforeEach(() => {
    mockAdapter = createMockMessagingAdapter();
    useCase = new SendStickerUseCase(mockAdapter);
  });
